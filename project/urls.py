...
urlpatterns = [
    ...
    path('profile/reset-password/', views.ResetPassword.as_view(), name='reset_password'),  # Forced password update
    path('profile/change-password/', views.ChangePassword.as_view(), name='change_password'),  # logged in user optional password update
