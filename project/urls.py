...
urlpatterns = [
    ...
    path('giftexchange/<int:giftexchange_id>/manage/assignments/sendemail/<int:target_appuser_id>/', admin_views.SendAssignmentEmail.as_view(), name='giftexchange_send_assignment_email'),
